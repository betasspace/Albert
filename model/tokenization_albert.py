...
PRETRAINED_POSITIONAL_EMBEDDINGS_SIZES = {
    'albert-base-zh': 512,
    'albert-large-zh': 512,
    'albert-xlarge-zh': 512,
}

PRETRAINED_INIT_CONFIGURATION = {
    'albert-base-zh': {'do_lower_case': True},
    'albert-large-zh': {'do_lower_case': True},
    'albert-xlarge-zh': {'do_lower_case': False},
}
...
class AlbertTokenizer(PreTrainedTokenizer):
    ...
    :class:`AlbertTokenizer` runs end-to-end tokenization: punctuation splitting + wordpiece
